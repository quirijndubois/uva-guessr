...
COPY --from=0 /opt/main/public/images /usr/local/apache2/htdocs/images
COPY --from=0 /opt/main/public/locations.json /usr/local/apache2/htdocs/locations.json
COPY --from=0 /opt/main/public/locations.csv /usr/local/apache2/htdocs/locations.csv
